...
**Quick start (engineers & AI agents):** [`docs/institutional-memory/07-ai-onboarding-curriculum.md`](docs/institutional-memory/07-ai-onboarding-curriculum.md)
...
| Build-2 tracking | [`docs/build-2/`](docs/build-2/) — [Coverage 97.2%](docs/institutional-memory/documentation-coverage-report.md) |
