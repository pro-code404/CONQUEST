...
| Status | Document |
|--------|----------|
| ✅ | [`docs/design/design-architecture-constitution.md`](design/design-architecture-constitution.md) |
| ✅ | [`docs/design/layout-system.md`](design/layout-system.md) |
| ✅ | [`docs/design/visual-language.md`](design/visual-language.md) |
| ✅ | [`docs/design/intelligence-models.md`](design/intelligence-models.md) |
| ✅ | [`docs/design/modules-registry.md`](design/modules-registry.md) |
| ✅ | [`docs/design/components.md`](design/components.md) |
