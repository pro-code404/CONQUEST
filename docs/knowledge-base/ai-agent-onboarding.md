...
**Current program:** Build-2 **M4 complete**. **M5 execution is gated** — requires Build-2 BAR (B-25–B-28). Recovery Phase 4 institutional memory complete ([97.2% coverage](../institutional-memory/documentation-coverage-report.md)).
